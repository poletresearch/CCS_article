...
filters_2100_plot <-  ggplot(filters_2100, aes(set, `2100`))+
  geom_area(data=count, aes(x=x, y=share*22, group = 1, alpha = 0.4), fill = "lightgrey", inherit.aes = FALSE)+
  ...
  scale_y_continuous("Cumulative capture and storage by 2100, GtCO2", expand = c(0.002,0.1), breaks = seq(500,2000,500),
                     sec.axis = sec_axis(~./22, name = "Share of scenarios for each temperature group, %", breaks = seq(20,80,20)))+
